    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "shadow-xl" : ""}`}
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-stretch" style={{ height: "66px" }}>
          ...
          {/* Logo */}
          <a href="/" className="flex items-center pr-4 cursor-pointer flex-shrink-0 py-2"
          ...
          <div className="hidden md:flex items-center gap-1 px-4 flex-1 justify-between">
            ...
            <div className="relative" onMouseEnter={() => setServicesOpen(true)} onMouseLeave={() => setTimeout(() => setServicesOpen(false), 150)}>
      ...
      {menuOpen && (
        <div className="md:hidden px-4 py-4 flex flex-col gap-3 text-sm font-medium"
          ...
          <a href="/" onClick={() => setMenuOpen(false)} style={{ color: "#F97316" }}>Úvod</a>
          ...
          <a href="tel:+420606079179" style={{ color: "rgba(255,255,255,.6)" }}>+420 606 079 179</a>
