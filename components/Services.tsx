...
export default function Services() {
  ...
  // Cards to show: next 3 services (not the active one)
  ...
  return (
    ...
    >
      {/* Background image — transitions between services */}
      {SERVICES.map((s, i) => (
        <div
          key={i}
      ...
      {/* Left content */}
      <div className="absolute left-0 bottom-0 p-8 md:p-14" style={{ maxWidth: "520px" }}>
      ...
      {/* Right cards */}
      <div
        className="absolute bottom-0 right-0 flex items-end gap-3 p-6 md:p-10"
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-center justify-between px-8 md:px-14 pb-5 pt-3">
        {/* Dots */}
